...
//}
//
//func (s *service) AddToFavourites(product FavouriteProduct, favouritesId string, userId int) error {
...
//}
//
//func (s *service) GetFavourites(userFavouritesId string) (favourites []FavouriteProduct, err error) {
...
//	}
//
//	var favourites []FavouriteProduct
//
//	if len(favouritesBytes) != 0 {
//		err = json.Unmarshal(favouritesBytes, &favourites)
//		if err != nil {
